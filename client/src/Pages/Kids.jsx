...
export default function Kids() {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [kidsProducts, selectedCategory, priceMax, showAiOnly, sortValue]);
  ...
  return (
    <div className="bg-white min-h-screen pt-20">
      <div className="max-w-360 mx-auto px-4 md:px-8">
        ...
        <CollectionHeader
          title="Kids"
          description="Comfort meets style for the little ones. Discover our playful collection of durable, high-quality clothing for children of all ages."
