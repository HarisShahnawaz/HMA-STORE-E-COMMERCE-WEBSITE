...
export default function NewArrivals() {
  const { products: globalNewArrivals, loading, error } = useProducts({ isNew: true }); // ← NEW
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [globalNewArrivals, selectedCategory, priceMax, showAiOnly, sortValue]);
